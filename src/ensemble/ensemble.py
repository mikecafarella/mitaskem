...
if __name__=="__main__":
    print("run main")
    # load_pdf("/Users/chunwei/research/mitaskem/resources/xDD/paper/Time-Varying COVID-19 Reproduction Number in the United States.pdf",
    #          "/Users/chunwei/research/mitaskem/resources/xDD/paper/Time-Varying COVID-19 Reproduction Number in the United States.txt")
    extract_variables("/Users/chunwei/research/mitaskem/resources/xDD/paper/COVID-19 Vaccine Effectiveness by Product and Timing in New York State.txt", "/Users/chunwei/research/mitaskem/resources/xDD/params")
